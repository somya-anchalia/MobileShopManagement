...
Public Class emp_id
    Dim x As String
    Private Sub frmeditpass_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Addn.Click
        x = "Add"
        ListView1.Enabled = False
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (x <> "Update") Then
            ...
            Else
                ...
                mongo.Connect()
                Dim db = mongo.GetDatabase("mobile_shop")
                Dim Collection1 = db.GetCollection(Of BsonDocument)("emp")
